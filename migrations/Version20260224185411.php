 ...
 */
final class Version20260224185411 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE post_like (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, post_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_653627B84B89032C (post_id), INDEX IDX_653627B8A76ED395 (user_id), UNIQUE INDEX unique_post_user_like (post_id, user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
