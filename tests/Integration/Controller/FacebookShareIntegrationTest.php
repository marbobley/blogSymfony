...
class FacebookShareIntegrationTest extends WebTestCase
{
    private EntityManagerInterface $entityManager;

    public function testFacebookShareButtonIsDisplayedOnPostPage(): void
    {
        ...
        $title = 'Article de test pour le partage Facebook';
        $slug = 'article-de-test-partage-facebook';
        $post = new Post($title, 'Contenu de l\'article de test pour vérifier le bouton Facebook.');
